...
const KNOWN_SDKS: Record<string, Omit<DetectedService, 'package'>> = {
  ...
  'groq-sdk': { name: 'groq', category: 'llm', autopriced: true },
  '@huggingface/inference': { name: 'huggingface', category: 'llm', autopriced: true },
  '@aws-sdk/client-bedrock-runtime': { name: 'amazon-bedrock', category: 'llm', autopriced: true },
  'grok-sdk': { name: 'xai', category: 'llm', autopriced: true },
