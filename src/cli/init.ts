...
export async function runInit(): Promise<void> {
  ...
  ${'b::::b'}                                            ${o('00::::::00')}
  ${'b::::b'}                                           ${o('0:::00:::0')}
  ${' b::::bbbbb'}    ${'uu::::uu'}  ${'rr::::rr'}    ${'nn::::nn'}   ${o('0::0  0::0')}
  ${' b::::::::bb'}   ${'u::::u'}   ${'r::::::::r'}   ${'n::::::n'}   ${o('0::0  0::0')}
  ${' b:::bb::::b'}   ${'u::::u'}   ${'rr:::::r'}     ${'n:nn:::n'}   ${o('0::0  0::0')}
  ${' b:::b b:::b'}   ${'u::::u'}    ${'r::::r'}      ${'n:n n::n'}   ${o('0::0  0::0')}
  ${' b:::b  b:::b'}  ${'u:::::uu'}  ${'r::::r'}      ${'n:n n::n'}   ${o('0::0  0::0')}
  ${' b:::bb::::b'}   ${'u::::::u'}  ${'r::::r'}      ${'n:n n::n'}   ${o('0:::00:::0')}
  ${' b::::::::b'}     ${'u:::::u'}  ${'r::::r'}      ${'n:n n::n'}    ${o('00::::::00')}
  ${' bbbbbbbbb'}      ${'uuuuuu'}   ${'rrrrrr'}      ${'nnn nnnn'}     ${o('000000')}
`
  console.log(banner)
